...
const lbl=$('accTotalLabel');if(lbl)lbl.textContent=t('spec_total');
const apl=$('accPriceApproxLabel');if(apl)apl.textContent=t('acc_price_approx');
}
...
// Inject mobile fix styles
(function(){const s=document.createElement('style');s.id='mobile-fix';s.textContent=`
@media(max-width:860px){
  .result-card .card-top,.acc-result-card .card-top{flex-direction:column!important;}
  .card-gallery{flex-direction:row!important;justify-content:flex-start!important;width:100%!important;}
  .gallery-main{width:120px!important;height:120px!important;flex-shrink:0!important;}
  .card-actions{flex-wrap:wrap!important;}
  .card-actions .btn-action{flex:1 1 calc(50% - 4px)!important;min-width:120px!important;justify-content:center!important;text-align:center!important;}
  .decode-blocks{flex-wrap:nowrap!important;overflow-x:auto!important;-webkit-overflow-scrolling:touch!important;padding-bottom:6px!important;}
  .sku-desc-box{max-width:100%!important;word-break:break-word!important;}
}
@media(max-width:520px){
  .card-inner{padding:12px 12px 12px 16px!important;}
  .gallery-main{width:88px!important;height:88px!important;}
  .card-actions{flex-wrap:wrap!important;gap:6px!important;}
  .card-actions .btn-action{flex:1 1 100%!important;width:100%!important;min-width:0!important;justify-content:center!important;text-align:center!important;white-space:normal!important;}
  .sku-code{font-size:15px!important;}
  .sku-price{font-size:17px!important;}
  .decode-block{min-width:56px!important;padding:6px 8px!important;}
  .decode-block-letter{font-size:17px!important;}
}
