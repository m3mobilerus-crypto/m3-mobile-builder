...
var lbl=document.getElementById('accTotalLabel');if(lbl)lbl.textContent=t('spec_total');
var apl=document.getElementById('accPriceApproxLabel');if(apl)apl.textContent=t('acc_price_approx');
}
...
(function(){
  ...
  s.textContent=[
    ...
    '.card-gallery{flex-direction:row!important;justify-content:flex-start!important;width:100%!important;max-width:100%!important;}',
    '.gallery-main{width:120px!important;height:120px!important;flex-shrink:0!important;}',
    '.card-actions{flex-wrap:wrap!important;}',
    '.card-actions .btn-action{flex:1 1 calc(50% - 4px)!important;min-width:110px!important;justify-content:center!important;text-align:center!important;}',
    ...
    '.sku-desc-box{max-width:100%!important;word-break:break-word!important;overflow-wrap:break-word!important;}',
    '}',
    '@media(max-width:520px){',
    '.card-inner{padding:12px 12px 12px 16px!important;}',
    '.gallery-main{width:88px!important;height:88px!important;}',
    '.card-actions .btn-action{flex:1 1 100%!important;width:100%!important;min-width:0!important;}',
